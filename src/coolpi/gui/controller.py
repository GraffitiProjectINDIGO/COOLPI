...
class Controller:
    ...
    def compute_cde(self):
        ...
        if data_sample_1["coordinates"]!=None:
            ...
            if data_sample_2["coordinates"] != None:
                ...
                path_out_cielab = os.path.join(*file_default_cielab)
    ...
    def load_spc_figure(self):
        ...
        path_img_out = os.path.join(*img_out)
        # create
    ...
    def plot_cpt_figures(self):
        ...
        if data["coordinates"] != None:
            ...
            path_out_chroma = os.path.join(*file_default_chromaticity)
            file_default_cielab = Config.instance().data["plot"]["file_default_cielab"]
            path_out_cielab = os.path.join(*file_default_cielab)
    ...
    #def open_irgbe(self):
    #    self.close_open_windows()
    #    self._view.open_irgbe_view()

    # LRM - Linear Regression Model 
    #def open_lrm(self):
    #    self.close_open_windows()
    #    self._view.open_lrm_view()
    ...
    def display_init_raw_image(self):
        ...
        if path_raw is not None:
            ...
            path_default = os.path.join(*Config.instance().data["rcip"]["default_raw_image"])
    ...
    def apply_white_balance_to_raw_image(self):
        ...
        if wb_multipliers!=None:
            ...
            # save default
            path_default = os.path.join(*Config.instance().data["rcip"]["default_wb_image"])
    ...
    def compute_colour_corrected_image(self):
        ...
        if RGB_to_XYZ!= None:
            ...
            if wb_multipliers!=None:
                ...
                # save default
                path_default = os.path.join(*Config.instance().data["rcip"]["default_colour_corrected"])
    ...
    def plot_zoom_spectral(self, window_title):
        ...
        path_out_spc = os.path.join(*file_default_spc)
    ...
    def plot_zoom_illuminant(self, window_title):
        ...
        path_out_spd = os.path.join(*file_default_spd)
