...
class AppView(QtWidgets.QMainWindow):
    ...
    def _create_logos(self):
        self._coolpi_label = Logo("coolpi", os.path.join(*[AppView.__current_dir, *Config.instance().data["logo"]["file_logo_coolpi"]]))
        self._lbi_label = Logo("LBI", os.path.join(*[AppView.__current_dir, *Config.instance().data["logo"]["file_logo_LBI"]]))
        self._indigo_label = Logo("Indigo", os.path.join(*[AppView.__current_dir, *Config.instance().data["logo"]["file_logo_indigo"]]))

    def _create_icons(self):
        self._cci_icon = QtGui.QIcon(os.path.join(*[AppView.__current_dir, *Config.instance().data["icon"]["file_cci_icon"]]))
        self._cde_icon = QtGui.QIcon(os.path.join(*[AppView.__current_dir, *Config.instance().data["icon"]["file_cde_icon"]]))        
        self._cpt_icon = QtGui.QIcon(os.path.join(*[AppView.__current_dir, *Config.instance().data["icon"]["file_cpt_icon"]]))           
        self._csc_icon = QtGui.QIcon(os.path.join(*[AppView.__current_dir, *Config.instance().data["icon"]["file_csc_icon"]]))
        ...
        self._quit_icon = QtGui.QIcon(os.path.join(*[AppView.__current_dir, *Config.instance().data["icon"]["file_quit_icon"]]))
        self._rcip_icon = QtGui.QIcon(os.path.join(*[AppView.__current_dir, *Config.instance().data["icon"]["file_rcip_icon"]]))     
        self._spc_icon = QtGui.QIcon(os.path.join(*[AppView.__current_dir, *Config.instance().data["icon"]["file_spc_icon"]]))
        self._spd_icon = QtGui.QIcon(os.path.join(*[AppView.__current_dir, *Config.instance().data["icon"]["file_spd_icon"]]))
    ...
    def _create_actions(self):
        ...
        # irgbe - image rgb data extraction
        #self._irgbe_action = QtGui.QAction(self._irgbe_icon, "RGB &Extraction")
        #self._irgbe_action.setStatusTip("Open the RGB Extraction Tool")
        #self._irgbe_action.setShortcut("Ctrl+E")
        
        # lrm - linear regression model
        #self._lrm_action = QtGui.QAction(self._lrm_icon, "Model")
        #self._lrm_action.setStatusTip("Open the Model Regression Tool")
        #self._lrm_action.setShortcut("Ctrl+M")   
        
        # wb - white balance
        #self._wb_action = QtGui.QAction(self._wb_icon, "&WhiteBalance")
        #self._wb_action.setStatusTip("Open the White Balancing Tool")
        #self._wb_action.setShortcut("Ctrl+W")    
    ...
    def _create_menu_bar(self):
        ...
        #self._menu_colourchecker.addAction(self._irgbe_action)  
        
        self._menu_image = QtWidgets.QMenu(" Image", self)
        #self._menu_image.addAction(self._lrm_action)  
        #self._menu_image.addAction(self._irgbe_action)  
        #self._menu_image.addAction(self._wb_action)  
    ...
    def _create_buttons(self):
        ...
        #self._irgbe_button = QtWidgets.QPushButton(self._irgbe_icon, "")
        #self._irgbe_button.setStatusTip("Open the RGB Extraction Tool")
        
        #self._lrm_button = QtWidgets.QPushButton(self._lrm_icon, "")
        #self._lrm_button.setStatusTip("Open the Model Regression Tool")  
        
        #self._wb_button = QtWidgets.QPushButton(self._wb_icon, "")
        #self._wb_button.setStatusTip("Open the White Balancing Tool")    
        ...
        list_buttons = [self._csc_button, self._cde_button, self._cpt_button,
                        ...
                        self._rcip_button] # self._irgbe_button, self._wb_button, 
    ...
    def _add_items(self):
        ...
        # image
        #self._grid_layout.addWidget(self._irgbe_button, 2, 0)
        #self._grid_layout.addWidget(self._wb_button, 2, 1)
        ...
        #self._grid_layout.addWidget(self._lbi_label, 3, 0, 1, 2,  QtCore.Qt.AlignRight)
        #self._grid_layout.addWidget(self._indigo_label, 3, 2, QtCore.Qt.AlignRight)
   ...
   # CPT - Plot
    ...
    # IRGBE - Image RGB data Extraction 
    #def open_irgbe_view(self):
    #    self._irgbe = IRGBE(self)
    #    self._irgbe.setFocus()
    #    self._irgbe.setVisible(True)
    #    posx = self.pos().x() + Config.instance().data["main"]["screen_size"][0]
    #    posy = self.pos().y()
    #    self._irgbe.set_position(posx, posy)
    #    self._irgbe.show() 
        
    # LRM - Linear Regression Model
    #def open_lrm_view(self):
    #    self._lrm = LRM(self)
    #    self._lrm.setFocus()
    #    self._lrm.setVisible(True)
    #    posx = self.pos().x() + Config.instance().data["main"]["screen_size"][0]
    #    posy = self.pos().y()
    #    self._lrm.set_position(posx, posy)
    #    self._lrm.show() 
...
class CSC(QtWidgets.QWidget):
    ...
    def create_indigo_logo(self):
        ...
        path_logo_indigo = os.path.join(*[CSC.__current_dir, *file_logo_indigo])
    ...
    def create_coolpi_logo(self):
        ...
        path_logo_coolpi = os.path.join(*[CSC.__current_dir, *file_logo_coolpi])
    ...
    def add_items(self):
        # first option
        #self._input_splitter = QtWidgets.QSplitter(QtCore.Qt.Horizontal)
        #self._colour_spaces_splitter = QtWidgets.QSplitter(QtCore.Qt.Horizontal)
        #self._input_splitter.addWidget(self._input_gb)
        #self._colour_spaces_splitter.addWidget(self._xyz_gb)
        #self._colour_spaces_splitter.addWidget(self._xyY_gb)
        #self._colour_spaces_splitter.addWidget(self._lab_gb)
        #self._colour_spaces_splitter.addWidget(self._srgb_gb)
                
        self._grid_layout = QtWidgets.QGridLayout()
        #self._grid_layout.addWidget(self._input_splitter, 0, 0)#, 0, 1)
        #self._grid_layout.addWidget(self._colour_spaces_splitter, 0, 1)#, 4, 0)
    ...
    def export_as_json(self):
        ...
        plot_default_dir = os.path.join(*[CSC.__current_dir, *Config.instance().data["dir_path"]["json_dir"]])
...
class CDE(QtWidgets.QWidget):
    ...
    def create_indigo_logo(self):
        file_logo_indigo = Config.instance().data["logo"]["file_logo_indigo"]
        path_logo_indigo = os.path.join(*[CDE.__current_dir, *file_logo_indigo])
        self._indigo = Logo("Indigo", path_logo_indigo)

    def create_coolpi_logo(self):
        file_logo_coolpi = Config.instance().data["logo"]["file_logo_coolpi"]
        path_logo_coolpi = os.path.join(*[CDE.__current_dir, *file_logo_coolpi])
        self._coolpi = Logo("coolpi", path_logo_coolpi)

    def create_default_image(self):
        file_default_image = Config.instance().data["plot"]["file_default_image"]
        path_default_image = os.path.join(*[CDE.__current_dir, *file_default_image])
    ...
    def create_buttons(self):
        ...
        path_zoom_icon = os.path.join(*[CDE.__current_dir, *file_zoom_icon])
        ...
        path_save_icon = os.path.join(*[CDE.__current_dir, *file_save_icon])
    ...
    def save_image(self):
        # save dialog
        save_dialog = QtWidgets.QFileDialog()
        plot_default_dir = os.path.join(*[CDE.__current_dir, *Config.instance().data["dir_path"]["plot_dir"]])
...
class SPC(QtWidgets.QWidget):
    ...
    def create_indigo_logo(self):
        file_logo_indigo = Config.instance().data["logo"]["file_logo_indigo"]
        path_logo_indigo = os.path.join(*[SPC.__current_dir, *file_logo_indigo])
        self._indigo = Logo("Indigo", path_logo_indigo)

    def create_coolpi_logo(self):
        file_logo_coolpi = Config.instance().data["logo"]["file_logo_coolpi"]
        path_logo_coolpi = os.path.join(*[SPC.__current_dir, *file_logo_coolpi])
        self._coolpi = Logo("coolpi", path_logo_coolpi)
    ...
    def create_buttons(self):
        ...
        # zoom
        file_zoom_icon = Config.instance().data["icon"]["file_zoom_icon"]
        path_zoom_icon = os.path.join(*[SPC.__current_dir, *file_zoom_icon])
        self._zoom_icon = QtGui.QIcon(path_zoom_icon)
        self._zoom_button = QtWidgets.QPushButton()
        self._zoom_button.setStyleSheet(f"background-color: {colour_orange}; color: white")
        self._zoom_button.setIcon(self._zoom_icon)
        ...
        # save
        file_save_icon = Config.instance().data["icon"]["file_save_icon"]
        path_save_icon = os.path.join(*[SPC.__current_dir, *file_save_icon])
        self._save_button = SaveButton(path_save_icon, size, True)
        # clear
        self._clear_button = QtWidgets.QPushButton()
        self._clear_button.setText("Clear")
    ...
    def load_from_json(self):
        ...
        json_default_dir = os.path.join(*[SPC.__current_dir, *Config.instance().data["dir_path"]["json_dir"]])
    ...
    def clear_labels(self):
        ...
        file_default_image = Config.instance().data["plot"]["file_default_image"]
        path_default_image = os.path.join(*[SPC.__current_dir, *file_default_image])
    ...
    def save_image(self):
        save_dialog = QtWidgets.QFileDialog()
        plot_default_dir = os.path.join(*[SPC.__current_dir, *Config.instance().data["dir_path"]["plot_dir"]])
...
class CPT(QtWidgets.QWidget):
    ...
    def create_indigo_logo(self):
        file_logo_indigo = Config.instance().data["logo"]["file_logo_indigo"]
        path_logo_indigo = os.path.join(*[CPT.__current_dir, *file_logo_indigo])
        self._indigo = Logo("Indigo", path_logo_indigo)

    def create_coolpi_logo(self):
        file_logo_coolpi = Config.instance().data["logo"]["file_logo_coolpi"]
        path_logo_coolpi = os.path.join(*[CPT.__current_dir, *file_logo_coolpi])
        self._coolpi = Logo("coolpi", path_logo_coolpi)
    ...
    def create_buttons(self):
        ...
        # zoom
        file_zoom_icon = Config.instance().data["icon"]["file_zoom_icon"]
        path_zoom_icon = os.path.join(*[CPT.__current_dir, *file_zoom_icon])
        self._zoom_icon = QtGui.QIcon(path_zoom_icon)
        ...
        # save
        file_save_icon = Config.instance().data["icon"]["file_save_icon"]
        path_save_icon = os.path.join(*[CPT.__current_dir, *file_save_icon])
    ...
    def save_image(self, plot_name):
        # save dialog
        save_dialog = QtWidgets.QFileDialog()
        plot_default_dir = os.path.join(*[CPT.__current_dir, *Config.instance().data["dir_path"]["plot_dir"]])
        save_path = save_dialog.getSaveFileName(self, "Save Current Plot", plot_default_dir, "Image files (*.png *.jpg)")
        path_file_png = save_path[0]
...
class SPD(QtWidgets.QWidget):
    ...
    def create_indigo_logo(self):
        file_logo_indigo = Config.instance().data["logo"]["file_logo_indigo"]
        path_logo_indigo = os.path.join(*[SPD.__current_dir, *file_logo_indigo])
        self._indigo = Logo("Indigo", path_logo_indigo)

    def create_coolpi_logo(self):
        file_logo_coolpi = Config.instance().data["logo"]["file_logo_coolpi"]
        path_logo_coolpi = os.path.join(*[SPD.__current_dir, *file_logo_coolpi])
        self._coolpi = Logo("coolpi", path_logo_coolpi)
    ...
    def create_buttons(self):
        ...
        # zoom
        file_zoom_icon = Config.instance().data["icon"]["file_zoom_icon"]
        path_zoom_icon = os.path.join(*[SPD.__current_dir, *file_zoom_icon])
        self._zoom_icon = QtGui.QIcon(path_zoom_icon)
        self._zoom_button = QtWidgets.QPushButton()
        self._zoom_button.setStyleSheet(f"background-color: {colour_orange}; color: white")
        self._zoom_button.setIcon(self._zoom_icon)
        ...
        # save
        file_save_icon = Config.instance().data["icon"]["file_save_icon"]
        path_save_icon = os.path.join(*[SPD.__current_dir, *file_save_icon])
        self._save_button = SaveButton(path_save_icon, size, True)
    ...
    def save_image(self):
        save_dialog = QtWidgets.QFileDialog()
        plot_default_dir = os.path.join(*[SPD.__current_dir, *Config.instance().data["dir_path"]["plot_dir"]])
        save_path = save_dialog.getSaveFileName(self, "Save Spectral Plot", plot_default_dir, "Image files (*.png *.jpg)")
        path_file_png = save_path[0]
        if path_file_png != "": # avoid error press cancel button
...
class CCI(QtWidgets.QWidget):
    ...
    def create_indigo_logo(self):
        file_logo_indigo = Config.instance().data["logo"]["file_logo_indigo"]
        path_logo_indigo = os.path.join(*[CCI.__current_dir, *file_logo_indigo])
        self._indigo = Logo("Indigo", path_logo_indigo)

    def create_coolpi_logo(self):
        file_logo_coolpi = Config.instance().data["logo"]["file_logo_coolpi"]
        path_logo_coolpi = os.path.join(*[CCI.__current_dir, *file_logo_coolpi])
        self._coolpi = Logo("coolpi", path_logo_coolpi)
    ...
    def create_buttons(self):
        ...
        # zoom
        file_zoom_icon = Config.instance().data["icon"]["file_zoom_icon"]
        path_zoom_icon = os.path.join(*[CCI.__current_dir, *file_zoom_icon])
        self._zoom_icon = QtGui.QIcon(path_zoom_icon)
        self._zoom_button= QtWidgets.QPushButton()
        self._zoom_button.setStyleSheet(f"background-color: {colour_orange}; color: white")
        self._zoom_button.setIcon(self._zoom_icon)
        ...
        # save
        file_save_icon = Config.instance().data["icon"]["file_save_icon"]
        path_save_icon = os.path.join(*[CCI.__current_dir, *file_save_icon])
    ...
    def save_image(self):
        # save dialog
        save_dialog = QtWidgets.QFileDialog()
        plot_default_dir = os.path.join(*[CCI.__current_dir, *Config.instance().data["dir_path"]["plot_dir"]])
        save_path = save_dialog.getSaveFileName(self, "Save Current Plot", plot_default_dir, "Image files (*.png *.jpg)")
        path_file_png = save_path[0]
        if path_file_png != "": # avoid error press cancel button
            self._spc_plot_gb.save_figure(path_file_png)
    ...
    def load_from_json(self):        
        load_dialog = QtWidgets.QFileDialog()
        json_default_dir = os.path.join(*[CCI.__current_dir, *Config.instance().data["dir_path"]["json_dir"]])
...
class RCIP(QtWidgets.QWidget):
    ...
    def create_indigo_logo(self):
        file_logo_indigo = Config.instance().data["logo"]["file_logo_indigo"]
        path_logo_indigo = os.path.join(*[RCIP.__current_dir, *file_logo_indigo])
        self._indigo = Logo("Indigo", path_logo_indigo)

    def create_coolpi_logo(self):
        file_logo_coolpi = Config.instance().data["logo"]["file_logo_coolpi"]
        path_logo_coolpi = os.path.join(*[RCIP.__current_dir, *file_logo_coolpi])
        self._coolpi = Logo("coolpi", path_logo_coolpi)
    ...
    def get_image_path(self):
        load_dialog = QtWidgets.QFileDialog()
        img_default_dir = os.path.join(*[RCIP.__current_dir, *Config.instance().data["dir_path"]["img_dir"]])
...
class WhiteBalanceFactorsGroupBox(QtWidgets.QGroupBox):
    ...
    def set_init_state(self):
        self.clear_labels()
        #self._none_radio_button.setChecked(True)
        self._camera_radio_button.setChecked(True)
        self.desactivate_radio_buttons()
        self.desactivate_labels()

    def create_radio_buttons(self):
        #self._none_radio_button = QtWidgets.QRadioButton()
        #self._none_radio_button.setText("None")
...
class RGBToXYZMatrixGroupBox(QtWidgets.QGroupBox):
    ...
    def get_path_csv(self):
        load_dialog = QtWidgets.QFileDialog()
        json_default_dir = os.path.join(*[RGBToXYZMatrixGroupBox.__current_dir, *Config.instance().data["dir_path"]["csv_dir"]])
...
class ImageViewGroupBox(QtWidgets.QGroupBox):
    ...
    def create_default_pixmap(self):
        file_default_image = Config.instance().data["plot"]["file_default_image"]
        path_default_image = os.path.join(*[ImageViewGroupBox.__current_dir, *file_default_image])
...
class FigureView(QtWidgets.QWidget):
    ...
    def create_indigo_logo(self):
        file_logo_indigo = Config.instance().data["logo"]["file_logo_indigo"]
        path_logo_indigo = os.path.join(*[FigureView.__current_dir, *file_logo_indigo])
        self._indigo = Logo("Indigo", path_logo_indigo)

    def create_coolpi_logo(self):
        file_logo_coolpi = Config.instance().data["logo"]["file_logo_coolpi"]
        path_logo_coolpi = os.path.join(*[FigureView.__current_dir, *file_logo_coolpi])
        self._coolpi = Logo("coolpi", path_logo_coolpi)
        
    def create_save_button(self):
        file_save_icon = Config.instance().data["icon"]["file_save_icon"]
        path_save_icon = os.path.join(*[FigureView.__current_dir, *file_save_icon])
        size = QtCore.QSize(Config.instance().data["icon"]["icon_size"][0],Config.instance().data["icon"]["icon_size"][0])
        self._save_button = SaveButton(path_save_icon, size, False)
    ...
    def save_image(self):
        save_dialog = QtWidgets.QFileDialog()
        plot_default_dir = os.path.join(*[FigureView.__current_dir, *Config.instance().data["dir_path"]["plot_dir"]])
        save_path = save_dialog.getSaveFileName(self, "Save Current Plot", plot_default_dir, "Image files (*.png *.jpg)")
        path_file_png = save_path[0]
        if path_file_png != "": # avoid error press cancel button
...
class InputIlluminantGroupBox(QtWidgets.QGroupBox):
    ...
    def get_path_csv(self):
        load_dialog = QtWidgets.QFileDialog()
        spd_default_dir = os.path.join(*[InputIlluminantGroupBox.__current_dir, *Config.instance().data["dir_path"]["spd_dir"]])
...
class InputChartGroupBox(QtWidgets.QGroupBox):
    ...
    def create_metadata(self): # table     
        ...
        #self._metadata_table.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        #self._metadata_table.setMinimumWidth(300)
        #self._metadata_table.setMaximumHeight(Config.instance().data["cci"]["max_height"])
        
        self.__fill_table_col_labels() # default

        #self._metadata_table.setEditTriggers(QtWidgets.QTableWidget.NoEditTriggers)
        #self._metadata_table.setSelectionMode(QtWidgets.QTableWidget.SingleSelection) # allowd only a one item
        #self._metadata_table.setSelectionBehavior(QtWidgets.QTableWidget.SelectRows) # selected row
...
class ChromaticityDiagramGroupBox(QtWidgets.QGroupBox):
    ...
    def create_defaul_image(self):
        file_default_image = Config.instance().data["plot"]["file_default_image"]
        path_default_image = os.path.join(*[ChromaticityDiagramGroupBox.__current_dir, *file_default_image])
...
class CielabPlotGroupBox(QtWidgets.QGroupBox):
    ...
    def create_default_image(self):
        file_default_image = Config.instance().data["plot"]["file_default_image"]
        path_default_image = os.path.join(*[CielabPlotGroupBox.__current_dir, *file_default_image])
...
class sRGBPlotGroupBox(QtWidgets.QGroupBox):
    ...
    def load_default_image(self):
        file_default_image = Config.instance().data["plot"]["file_default_image"]
        path_default_image = os.path.join(*[sRGBPlotGroupBox.__current_dir, *file_default_image])
...
class SpectralPlotGroupBox(QtWidgets.QGroupBox):
    ...
    def create_default_pixmap(self):
        file_default_image = Config.instance().data["plot"]["file_default_image"]
        path_default_image = os.path.join(*[SpectralPlotGroupBox.__current_dir, *file_default_image])
        self._spc_image = QtGui.QPixmap(path_default_image)
...
class IlluminantPlotGroupBox(QtWidgets.QGroupBox):
    ...
    def create_default_pixmap(self):
        file_default_image = Config.instance().data["plot"]["file_default_image"]
        path_default_image = os.path.join(*[IlluminantPlotGroupBox.__current_dir, *file_default_image])
