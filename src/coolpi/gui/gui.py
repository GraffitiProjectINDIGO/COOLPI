...
class AppView(QtWidgets.QMainWindow):
    ...
    def _create_logos(self):
        self._lbi_label = Logo("coolpi", os.path.join(*Config.instance().data["logo"]["file_logo_coolpi"]))
        self._lbi_label = Logo("LBI", os.path.join(*Config.instance().data["logo"]["file_logo_LBI"]))
        self._indigo_label = Logo("Indigo", os.path.join(*Config.instance().data["logo"]["file_logo_indigo"]))

    def _create_icons(self):
        self._cci_icon = QtGui.QIcon(os.path.join(*Config.instance().data["icon"]["file_cci_icon"]))
        self._cde_icon = QtGui.QIcon(os.path.join(*Config.instance().data["icon"]["file_cde_icon"]))        
        self._cpt_icon = QtGui.QIcon(os.path.join(*Config.instance().data["icon"]["file_cpt_icon"]))           
        self._csc_icon = QtGui.QIcon(os.path.join(*Config.instance().data["icon"]["file_csc_icon"]))
        ...
        self._quit_icon = QtGui.QIcon(os.path.join(*Config.instance().data["icon"]["file_quit_icon"]))
        self._rcip_icon = QtGui.QIcon(os.path.join(*Config.instance().data["icon"]["file_rcip_icon"]))     
        self._spc_icon = QtGui.QIcon(os.path.join(*Config.instance().data["icon"]["file_spc_icon"]))
        self._spd_icon = QtGui.QIcon(os.path.join(*Config.instance().data["icon"]["file_spd_icon"]))
...
class CSC(QtWidgets.QWidget):
    ...
    def create_indigo_logo(self):
        ...
        path_logo_indigo = os.path.join(*file_logo_indigo)
    ...
    def create_coolpi_logo(self):
        ...
        path_logo_coolpi = os.path.join(*file_logo_coolpi)
    ...
    def export_as_json(self):
        ...
        plot_default_dir = os.path.join(*Config.instance().data["dir_path"]["json_dir"])
...
class CDE(QtWidgets.QWidget):
    ...
    def create_default_image(self):
        ...
        path_default_image = os.path.join(*file_default_image)
    ...
    def create_buttons(self):
        ...
        path_zoom_icon = os.path.join(*file_zoom_icon)
        ...
        path_save_icon = os.path.join(*file_save_icon)
    ...
    def save_image(self):
        # save dialog
        save_dialog = QtWidgets.QFileDialog()
        plot_default_dir = os.path.join(*Config.instance().data["dir_path"]["plot_dir"])
...
class SPC(QtWidgets.QWidget):
    ...
    def load_from_json(self):
        ...
        json_default_dir = os.path.join(*Config.instance().data["dir_path"]["json_dir"])
...
class RCIP(QtWidgets.QWidget):
    ...
    def get_image_path(self):
        load_dialog = QtWidgets.QFileDialog()
        img_default_dir = os.path.join(*Config.instance().data["dir_path"]["img_dir"])
...
class RGBToXYZMatrixGroupBox(QtWidgets.QGroupBox):
    ...
    def get_path_csv(self):
        load_dialog = QtWidgets.QFileDialog()
        json_default_dir = os.path.join(*Config.instance().data["dir_path"]["csv_dir"])
...
class InputIlluminantGroupBox(QtWidgets.QGroupBox):
    ...
    def get_path_csv(self):
        load_dialog = QtWidgets.QFileDialog()
        spd_default_dir = os.path.join(*Config.instance().data["dir_path"]["spd_dir"])
