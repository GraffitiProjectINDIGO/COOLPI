...
def compute_ciede2000(LAB1, LAB2):
    L1, a1, b1 = LAB1
    lab1 = CIELAB("sample1", L1, a1, b1, "D65", 2)
    L2, a2, b2 = LAB2
    lab2 = CIELAB("sample1", L2, a2, b2, "D65", 2)
...
def compute_colour_differences(colourchecker_xyz):
    ...
    dataframe_assesment_model["CIEDE2000"] = dataframe_assesment_model.apply(lambda x: compute_ciede2000(x["LAB(D65)"],x["LAB'(D65)"]), axis=1)
