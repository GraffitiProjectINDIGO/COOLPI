...
class ColourCheckerSpectral(ColourChecker):
    ...
    def plot_patches(self, patches_id, show_figure = True, save_figure = False, output_path = None):
        ...
        if len(patches_id)>10:
            raise PlotSpectralSampleError("Too many samples to plot: the maximun reflectance samples allowed to compare is 10")
...
class ColourCheckerLAB(ColourChecker):
    ...
    def plot_patches(self, patches_id, show_figure = True, save_figure = False, output_path = None):
        '''
        Method to plot the LAB data of a given colour patches.
        ...
        if len(patches_id)>10:
            raise PlotSpectralSampleError("Too many samples to plot: the maximun LAB samples allowed to compare is 10")
